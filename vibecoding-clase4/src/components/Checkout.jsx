...
export default function Checkout({ isPremium, onTogglePremium, coupon, onChangeCoupon, region, onChangeRegion, totalDisplay, onConfirm }) {
  return (
    <section>
      <h2>Checkout</h2>
      <label>
      ...
      <div style={{ marginTop: 8 }}>
        <label> Cupón: </label>
        <select value={coupon} onChange={onChangeCoupon}>
